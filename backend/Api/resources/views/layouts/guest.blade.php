    ...
    <body>
        <div class="motorcycle-container">
            ...
            <div class="logo-wrapper mb-6">
                <a href="/">
                    <x-application-logo class="w-24 h-24 fill-current text-engine-red" />
                </a>
            </div>
            ...
            <div class="dashboard-panel">
                ...
                <div class="panel-header">
                    <h1 class="panel-heading">SKBT Motorcycle Parts</h1>
                </div>
            ...
            <div class="login-footer">
                <p>&copy; 2025 SKBT Motorcycle Parts. All rights reserved.</p>
